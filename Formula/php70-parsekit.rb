...
class Php70Parsekit < AbstractPhp70Extension
  init
  ...
  patch do
    ...
    url "https://gist.githubusercontent.com/SteelPangolin/864f0ddf7291eaa7eccf/raw/6a8a7d6ae44a2d8c43ce205b1a41dc6f23cab0ea/php-pecl-parsekit-1.3-php70-variadic-fix.patch"
